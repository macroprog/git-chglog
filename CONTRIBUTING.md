...
If you find a bug in the source code, you can help us by [submitting an issue](https://github.com/macroprog/git-chglog/issues) to our [GitHub Repository](https://github.com/macroprog/git-chglog). Even better, you can submit a Pull Request with a fix.
